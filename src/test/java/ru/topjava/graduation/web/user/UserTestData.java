...
import static ru.topjava.graduation.web.vote.VoteTestData.USER_VOTE;
...
public class UserTestData {
    ...
    public static final User user2 = new User(USER_ID + 2, "User2", "user2@yandex.ru", "user2", Role.USER);
    ...
    static {
        user.setVotes(List.of(USER_VOTE));
    }
